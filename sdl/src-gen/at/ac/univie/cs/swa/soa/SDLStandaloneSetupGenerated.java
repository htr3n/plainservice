...
public class SDLStandaloneSetupGenerated implements ISetup {
	...
	if (!EPackage.Registry.INSTANCE.containsKey("http://cs.univie.ac.at/swa/plainservice/sdl")) {
		EPackage.Registry.INSTANCE.put("http://cs.univie.ac.at/swa/plainservice/sdl", at.ac.univie.cs.swa.soa.sdl.SdlPackage.eINSTANCE);
	}
