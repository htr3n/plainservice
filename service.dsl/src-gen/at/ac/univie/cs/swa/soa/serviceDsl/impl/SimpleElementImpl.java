 ...
 * <ul>
 *   <li>{@link at.ac.univie.cs.swa.soa.serviceDsl.impl.SimpleElementImpl#getType <em>Type</em>}</li>
 *   <li>{@link at.ac.univie.cs.swa.soa.serviceDsl.impl.SimpleElementImpl#getRef <em>Ref</em>}</li>
 *   <li>{@link at.ac.univie.cs.swa.soa.serviceDsl.impl.SimpleElementImpl#getMultiplicity <em>Multiplicity</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SimpleElementImpl extends DataElementImpl implements SimpleElement
{
  ...
  {
    return ServiceDslPackage.Literals.SIMPLE_ELEMENT;
  }
  ...
  public void setType(DATATYPE newType)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ServiceDslPackage.SIMPLE_ELEMENT__TYPE, oldType, type));
  }
  ...
  public ComplexElement getRef()
  {
    if (ref != null && ref.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, ServiceDslPackage.SIMPLE_ELEMENT__REF, oldRef, ref));
      }
    }
    return ref;
  }
  ...
  public void setRef(ComplexElement newRef)
  {
    ...
    ref = newRef;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ServiceDslPackage.SIMPLE_ELEMENT__REF, oldRef, ref));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ServiceDslPackage.SIMPLE_ELEMENT__TYPE:
        return getType();
